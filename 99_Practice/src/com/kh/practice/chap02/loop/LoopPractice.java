...
public class LoopPractice {
	...
	public void practice1() {
		...
		if (num < 1) {
			System.out.println("1이상의 숫자르 입력해주세요.");
			return;
		}
		
		//입력받은 숫자가 1 이상이면 1부터 입력받은 숫자까지 모두 출력해주시
		for (int i = 1; i <= num; i++) {
			System.out.print(i + " ");
	...
	public void practice4() {
		...
		int num; // practice4 안에서 어디서든 num을 알 수 있도록 바깥에서 호출해줌
	...
	public void practice7() {
		...
		while(true) {
			...
			if (firstNum >= 1 && secondNum >= 1) {
				...
				//Math(수학 파일에서) 가장 작은 값을 찾는 min 을 활용해서
	...
	public void practice12() {
		...
		while(true) {
			...
			//만약에 exit를 입력해서 프로그램을 종료를 원할 경우
