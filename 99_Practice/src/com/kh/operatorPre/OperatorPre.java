...
public class OperatorPre {
	...
	public static void practice2() {//키보드로 정보 입력받기 + 남 여 확인
		...
		//			 println : 다출력한다음에 다음줄에서 작성하기 Enter
		//			  printf : 서식이 지정된 문자열을 출력할 때 사용
		// %d : 10진수 정수 %f : 소수점 수 %s : 문자열 출력 %c : 문자 하나 출력
		// %b : true인지 false 출력 %x : 16진수 정수 %o : 8진수 정수
	...
	public static void method4() {
		...
		System.out.print("두 분째 수를 입력하세요 : ");
		int num2 = sc.nextInt();
	...
	//실습문제 4번 응용
	//2개의 수를 키보드로 입력 받아 입력 받은 수가 모두 다르면 true 모두 같으면 false 출력
	
	public static void practice4() {
		Scanner sc = new Scanner(System.in);
		System.out.print("num1 수를 입력해주세요 : ");
		int num1 = sc.nextInt();
		System.out.print("num2 수를 입력해주세요 : ");
		int num2 = sc.nextInt();
		
		boolean 참거짓 =  num1 != num2;
		System.out.println("num1 과 num2의 결과는 : " + 참거짓);
